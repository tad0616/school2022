...
define('TF_TOP_SELECT_CONTENT', '選擇欲出現的內容');
define('TF_TOP_CONTENT', '自訂內容');
define('TF_TOP_CONTENT_DESC', '可以加入任何內容（html）');
define('TF_NONE', '無');
...
define('TF_TOP_COLS', '設定左中右的呈現欄寬');
define('TF_TOP_COLS_DESC', '填入三個數字，以-隔開，勿有空白，總和需為 12，如：4-4-4 或 3-6-3');
