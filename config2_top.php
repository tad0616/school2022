...
$theme_config[$i]['text'] = TF_TOP_COLS;
$theme_config[$i]['desc'] = TF_TOP_COLS_DESC;
$theme_config[$i]['type'] = "text";
...
$theme_config[$i]['desc'] = TF_TOP_LEFT . TF_TOP_SELECT_CONTENT;
...
$theme_config[$i]['text'] = TF_TOP_LEFT . TF_TOP_CONTENT;
$theme_config[$i]['desc'] = TF_TOP_LEFT . TF_TOP_CONTENT_DESC;
$theme_config[$i]['type'] = "textarea";
$theme_config[$i]['default'] = "";
...
$theme_config[$i]['desc'] = TF_TOP_CENTER . TF_TOP_SELECT_CONTENT;
$theme_config[$i]['type'] = "select";
$theme_config[$i]['options'] = ['' => TF_NONE, 'search' => TF_SEARCH, 'login' => TF_LOGIN, 'menu' => TF_MENU, 'google_translate' => TF_GOOGLE_TRANSLATE, 'html' => TF_HTML];
$theme_config[$i]['default'] = "";
...
$theme_config[$i]['text'] = TF_TOP_CENTER . TF_TOP_CONTENT;
$theme_config[$i]['desc'] = TF_TOP_CENTER . TF_TOP_CONTENT_DESC;
$theme_config[$i]['type'] = "textarea";
$theme_config[$i]['default'] = "";
...
$theme_config[$i]['desc'] = TF_TOP_RIGHT . TF_TOP_SELECT_CONTENT;
$theme_config[$i]['type'] = "select";
$theme_config[$i]['options'] = ['' => TF_NONE, 'search' => TF_SEARCH, 'login' => TF_LOGIN, 'menu' => TF_MENU, 'google_translate' => TF_GOOGLE_TRANSLATE, 'html' => TF_HTML];
$theme_config[$i]['default'] = "";
...
$theme_config[$i]['text'] = TF_TOP_RIGHT . TF_TOP_CONTENT;
$theme_config[$i]['desc'] = TF_TOP_RIGHT . TF_TOP_CONTENT_DESC;
$theme_config[$i]['type'] = "textarea";
$theme_config[$i]['default'] = "";
